...
def statistical(segment : np.ndarray):
    ...
    features['dwt_svd_entropy'] = svd_entropy(cA4, D = 3, tau = 1)
    features['dwt_shannon_entropy'] = shannon_entropy(cA4)
    ...
    features['dwt1_svd_entropy'] = svd_entropy(cA4_d, D = 3, tau = 1)
    features['dwt1_shannon_entropy'] = shannon_entropy(cA4_d)
    ...
    features['dwt2_svd_entropy'] = svd_entropy(cA4_d2, D = 3, tau = 1)
    features['dwt2_shannon_entropy'] = shannon_entropy(cA4_d2)
